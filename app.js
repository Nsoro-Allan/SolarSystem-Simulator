        ...
        const planets = [
            {
                ...
                color: "#a9a9a9",
                period: 88,
                imageUrl: "https://images-assets.nasa.gov/image/PIA11245/PIA11245~large.jpg",
                moons: 0,
                travelTime: "~6 years",
                facts: ["Extreme temperature variations", "No atmosphere", "Smallest planet"]
            },
            {
                name: "Venus",
                distance: 0.72,
            ...
            },
            {
                ...
                color: "#ff4500",
                period: 687,
                imageUrl: "https://images-assets.nasa.gov/image/PIA04591/PIA04591~large.jpg",
                moons: 2,
                travelTime: "~7 years",
            ...
            },
            {
                ...
                color: "#ffa500",
                period: 4333,
                imageUrl: "https://images-assets.nasa.gov/image/PIA21973/PIA21973~large.jpg",
                moons: 79,
                travelTime: "~5 years",
            ...
            },
            {
                ...
                color: "#f0e68c",
                period: 10759,
                imageUrl: "https://images-assets.nasa.gov/image/PIA02222/PIA02222~large.jpg",
                moons: 82,
                travelTime: "~7 years",
        ...
        function togglePlanetInfo(planet) {
            if (infoDiv.style.display === 'block' && infoDiv.dataset.planet === planet.name) {
                infoDiv.style.display = 'none';
            } else {
                const auToKm = 149597870;
                const distanceKm = (planet.distance * auToKm).toLocaleString();
                let travelTimeHtml = planet.name !== "Earth" ? `<p><strong>Estimated Travel Time:</strong> ${planet.travelTime}</p>` : '';
        ...
        function animate(currentTimestamp) {
            if (isRunning) {
                ...
                planets.forEach(planet => {
                    const angle = (planet.initialAngle + 2 * Math.PI * totalSimulationDays / planet.period) % (2 * Math.PI);
                    const radius = getRadius(planet.distance);
